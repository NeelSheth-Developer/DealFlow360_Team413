...
const ENDPOINTS = [
  ...
  ['Auth', [
    { m: 'POST', p: '/auth/signup', auth: 'none',
      ...
      b: B({ name: 'Priya Sharma', email: 'priya@teamvector.space', password: 'S3cure!pass', type: 'internal' }),
    ...
    { m: 'POST', p: '/auth/login', auth: 'none',
      ...
      b: B({ email: '{{staffEmail}}', password: 'S3cure!pass', type: 'internal' }),
      capture: { staffToken: 'data.accessToken', refreshToken: 'data.refreshToken' } },
    { m: 'POST', p: '/auth/login', name: 'Login (admin)', auth: 'none',
      ...
      b: B({ email: 'admin@teamvector.space', password: 'S3cure!pass', type: 'internal' }),
      capture: { staffToken: 'data.accessToken', refreshToken: 'data.refreshToken' } },
    { m: 'POST', p: '/auth/signup', name: 'Signup (customer)', auth: 'none',
      ...
      b: B({ name: 'Acme Corp', email: 'buyer@acme.example', password: 'Acme@2026x', type: 'customer' }),
    ...
    { m: 'POST', p: '/auth/login', name: 'Login (customer)', auth: 'none',
      b: B({ email: '{{customerEmail}}', password: 'Acme@2026x', type: 'customer' }),
      capture: { customerToken: 'data.accessToken' } },
    { m: 'GET', p: '/auth/me' },
